<!DOCTYPE html>
<html lang="zh-CN" style="overflow-y: hidden;">
<head>
...
<link rel="stylesheet" id="home-css" href="<?php bloginfo('template_directory'); ?>/css/cms.css" type="text/css" media="all">
<?php } ?>
<?php if (is_single() || is_page() ) { ?>
<link rel="stylesheet" id="home-css" href="<?php bloginfo('template_directory'); ?>/css/highlight.css" type="text/css" media="all">
