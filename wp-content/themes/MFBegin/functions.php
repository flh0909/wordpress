...
//avatar头像缓存
function my_avatar( $email = 'mfbegin@boke123.net', $size = '40', $default = '', $alt = '') {
...
$skin_option = get_option('ygj_theme_skin'); 
	...
	if ($skin_option && ($skin_option !== "C01E22")) { 
		$styles .= ".dp-highlighter:hover {border: 1px dashed $skc;}.icon-cat,a:hover,.top-menu a:hover,.default-menu li a,#user-profile a:hover,#site-nav .down-menu > li > a:hover,#site-nav .down-menu > li.sfHover > a,#site-nav .down-menu > .current-menu-item > a,#site-nav .down-menu > .current-menu-item > a:hover,.entry-meta a,.single-content a, .single-content a:visited,.showmore span,.single-meta a:hover,.widget-title .icon-cat,.floor,.at, .at a,#dzq .readers-list a:hover em,#dzq .readers-list a:hover strong,.single-content a:hover{color: $skc;}#navigation-toggle:hover,.nav-mobile:hover,.mobile-menu a:hover,#searchform button,.entry-more a,.page-links span,.page-links a:hover span,.single-meta .comment a:hover,.single-meta .edit-link a:hover,.single-meta .r-hide a:hover, #fontsize:hover,.picture-img i,.picture-h-img i ,.meta-nav:hover, .nav-single i:hover,.widget_categories a:hover,.widget_links a:hover,.tagcloud a:hover,#sidebar .widget_nav_menu a:hover,.reply a:hover,#respond #submit:hover ,.comment-tool a:hover,.pagination span.current,.pagination a:hover,.pagination .prev,.pagination .next,#scroll li a:hover,.rslides_tabs .rslides_here a,#down a,.buttons a ,.nav-search,.title-l ,.new-icon, .post-format a,.aside-cat,.thumbnail .cat,.li-icon-1,.li-icon-2,.li-icon-3,.slider-caption ,.new-ico,.expand_collapse {background: $skc;}#navigation-toggle:hover,.nav-mobile:hover.mobile-menu a:hover,.page-links span,.page-links a:hover span,.single-meta .comment a:hover,.single-meta .edit-link a:hover,.single-meta .r-hide a:hover, #fontsize:hover,.meta-nav:hover, .nav-single i:hover,.widget_categories a:hover,.widget_links a:hover,.tagcloud a:hover,#sidebar .widget_nav_menu a:hover,.reply a:hover,.comment-tool a:hover,.pagination span.current,.pagination a:hover,#scroll li a:hover,.rslides_tabs .rslides_here a,#down a,.buttons a ,.nav-search,.new-ico,#respond #submit:hover ,.expand_collapse{border: 1px solid $skc;}.entry-more a{border-right: 3px solid $skc;}.entry-header h1{border-right: 5px solid $skc;}.entry-header h1,.single-content h3,.single-content .directory,.archives-yearmonth{border-left: 5px solid $skc;}#dzq .readers-list a:hover{border-color:$skc;}.slider-caption,.thumbnail .cat ,.aside-cat {background: none repeat scroll 0 0 $skc;}"; 
	}  
	if ($styles) { 
