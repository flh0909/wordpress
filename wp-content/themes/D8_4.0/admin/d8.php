...
<div class="wrap d_wrap">
    ...
    <h2><?php echo $themename; ?>设置
        <span class="d_themedesc" style="display: none;">设计师：<a href="http://www.daqianduan.com/" target="_blank">浩子</a> &nbsp;&nbsp; <a href="http://www.daqianduan.com/theme/d8/" target="_blank">访问<?php echo $themename; ?>主页</a></span>
    </h2>
...
<form method="post" class="d_formwrap">
    ...
    <tr>
        <td class="d_tit">邮箱</td>
        <td>
            <input class="ipt-b" type="text" id="d_contact_mail" name="d_contact_mail" value="<?php echo dopt('d_contact_mail'); ?>">
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="d_tit">正文字体大小</td>
        <td>
             <input class="d_num" name="article_content_fontsize" id="article_content_fontsize" type="number" value="<?php if( dopt('article_content_fontsize') ) echo dopt('article_content_fontsize'); else echo '16'; ?>">px，默认14，建议在14-16之间
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="d_tit">广告位不显示在移动端</td>
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_banner_show" name="d_banner_show" <?php if(dopt('d_banner_show')) echo 'checked="checked"' ?>>开启
            </label>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_navfix" name="d_navfix" <?php if(dopt('d_navfix')) echo 'checked="checked"' ?>>开启 (该功能在移动端无效)
            </label>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="d_tit">列表Ajax加载分页内容</td>
        <td>
            <label class="checkbox inline">
    ...
    <tr>
        ...
        <td>
            显示<input class="d_num" name="d_related_count" id="d_related_count" type="number" value="<?php echo dopt('d_related_count'); ?>">条 默认 12
        </td>
    </tr>
        <tr>
            <td class="d_tit">文章列表每页显示条数</td>
            <td>
                显示<input class="d_num" name="posts_per_page" id="posts_per_page" type="number" value="<?php echo dopt('posts_per_page'); ?>">条
            </td>
        </tr>
    <tr>
    ...
    <tr>
        <td class="d_tit">用户登录信息</td>
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_sign_b" name="d_sign_b" <?php if(dopt('d_sign_b')) echo 'checked="checked"' ?>>开启
            </label>
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            投稿时间间隔 <input class="d_num" name="d_tougao_time" id="d_tougao_time" type="number" value="<?php if( dopt('d_tougao_time') ) echo dopt('d_tougao_time'); else echo '240'; ?>"> 秒，默认：240
            <br>
            内容字数限制在 <input class="d_num" name="d_tougao_contentmin" id="d_tougao_contentmin" type="number" value="<?php if( dopt('d_tougao_contentmin') ) echo dopt('d_tougao_contentmin'); else echo '200'; ?>"> - <input class="d_num" name="d_tougao_contentmax" id="d_tougao_contentmax" type="number" value="<?php if( dopt('d_tougao_contentmax') ) echo dopt('d_tougao_contentmax'); else echo '5000'; ?>"> 之间
            <br>
    ...
    <tr>
        <td class="d_tit">百度分享 Appkey</td>
        <td>
            腾讯微博：<input style="width:100px;" name="t_appkey_tqq" id="t_appkey_tqq" type="text" value="<?php if( dopt('t_appkey_tqq') ) echo dopt('t_appkey_tqq'); else echo '801494063'; ?>">
            新浪微博：<input style="width:100px;" name="t_appkey_tsina" id="t_appkey_tsina" type="text" value="<?php if( dopt('t_appkey_tsina') ) echo dopt('t_appkey_tsina'); else echo '1106777879'; ?>">
            网易微博：<input style="width:100px;" name="t_appkey_t163" id="t_appkey_t163" type="text" value="<?php if( dopt('t_appkey_t163') ) echo dopt('t_appkey_t163'); else echo ''; ?>">
            搜狐微博：<input style="width:100px;" name="t_appkey_tsohu" id="t_appkey_tsohu" type="text" value="<?php if( dopt('t_appkey_tsohu') ) echo dopt('t_appkey_tsohu'); else echo ''; ?>">
            <br>
            <span class="d_tip">Appkey 获取方式：需要自行去各微博开放平台创建分享应用获取</span>
        </td>
    </tr>
    <tr>
