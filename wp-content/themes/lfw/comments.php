...
<div id="comments" class="comments-area" name="comments">
	...
	<?php $my_email = get_bloginfo ( 'admin_email' );
			...
			AND comment_approved = '1' AND comment_type = '' AND comment_author_email";echo $wpdb->get_var("$str != '$my_email'");?>
	条<a href="www.toptheme.org" target="_blank">评</a><a href="www.laladianying.com" target="_blank">论</a> </h2>
<!-- 显示正在加载新评论 -->
